...
export function SettingsDrawer({ open, onOpenChange }: SettingsDrawerProps) {
  ...
  }, [settings.waterIncrement, settings.waterLimit, settings.saltIncrement, settings.saltLimit, settings.scrollDurationMs, settings.autoHideDelayMs, settings.barTransitionDurationMs]);
  ...
  const handleResetToDefaults = () => {
    ...
    setScrollDurationInput("300");
    setAutoHideDelayInput("500");
    setBarTransitionInput("200");
    toast({
                      ...
                      <div className="space-y-2">
                        ...
                        <NumericInput
                          ...
                          onBlur={() => validateAndSave(
                            ...
                            settings.setScrollDurationMs,
                            setScrollDurationInput
                          )}
                          min={100}
                          max={1000}
                          step={50}
                      ...
                      <div className="space-y-2">
                        ...
                        <NumericInput
                          ...
                          onBlur={() => validateAndSave(
                            ...
                            settings.setAutoHideDelayMs,
                            setAutoHideDelayInput
                          )}
                          min={0}
                          max={2000}
                          step={100}
                      ...
                      <div className="space-y-2">
                        ...
                        <NumericInput
                          ...
                          onBlur={() => validateAndSave(
                            ...
                            50,
                            500,
                            settings.barTransitionDurationMs,
                            settings.setBarTransitionDurationMs,
                            setBarTransitionInput
                          )}
                          min={50}
                          max={500}
                          step={50}
