...
- Usage: Reference from command with `@/home/ryan/repos/Personal/intake-tracker/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/ryan/repos/Personal/intake-tracker/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/ryan/repos/Personal/intake-tracker/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
