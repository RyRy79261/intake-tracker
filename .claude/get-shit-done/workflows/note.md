...
- **Global scope**: `/home/ryan/repos/Personal/intake-tracker/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ryan/repos/Personal/intake-tracker/.claude/notes/`)
...
2. Glob `/home/ryan/repos/Personal/intake-tracker/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/ryan/repos/Personal/intake-tracker/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ryan/repos/Personal/intake-tracker/.claude/notes/` — works in any directory
