...
Reference full template: `/home/ryan/repos/Personal/intake-tracker/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ryan/repos/Personal/intake-tracker/.claude/get-shit-done/templates/state.md`.
