...
Use template from `/home/ryan/repos/Personal/intake-tracker/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/ryan/repos/Personal/intake-tracker/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/ryan/repos/Personal/intake-tracker/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
