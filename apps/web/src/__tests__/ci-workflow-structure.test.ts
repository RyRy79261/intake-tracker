...
// Repo-level invariant: .github lives at the monorepo root, two levels up from
// this package (apps/web). (Turborepo Phase 1; the CI rewrite in Phase 5 will
// revisit this test — possibly relocating it to a root-level test runner.)
const CI_YML_PATH = path.resolve(
  process.cwd(),
  "../..",
