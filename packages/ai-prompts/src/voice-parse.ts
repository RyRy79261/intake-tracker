...
- "caffeine": description, caffeineMg (e.g. drip coffee 250ml ~ 95mg, espresso 30ml ~ 63mg, tea ~ 47mg), volumeMl (volume of the drink in ml — ALWAYS provide it; it is how the app records the drink's fluid), sugarG (optional, sugars dissolved in the drink — a latte's milk sugar ~12, sweetened iced tea 330ml ~ 25), sodiumMg (optional), potassiumMg (optional)
